...
if __name__ == "__main__":
    ...
    files = [f"/home/elliott/Development/files/execution_ratio_{args.date}.csv"]
    subject = f"Daily Execution Ratios Report {args.date} "
    subject2 = f"Daily Execution Ratios Report {args.date} (Late)"
