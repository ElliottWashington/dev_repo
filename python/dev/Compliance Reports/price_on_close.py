...
if __name__ == "__main__":
    ...
    files = [f"/home/elliott/Development/files/price_on_close_{date}.txt"]
    subject = f"Price on Close Report {args.date} "
    subject2 = f"Price on Close Report {args.date} (Late)"
