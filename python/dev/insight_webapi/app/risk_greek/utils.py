...
def db_query_account_numbers():
    query = "SELECT DISTINCT account FROM greek_data where account like '3OB%'"
    account_number_dicts = db_query(query, "2", format_cols=None)
    account_numbers = [d['account'] for d in account_number_dicts]
